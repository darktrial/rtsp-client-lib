...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/jemic/rtsp-client-lib/ffmpeg-4.4.4/install --disable-x86asm --disable-everything --enable-decoder='h264,hevc,mjpeg' --enable-protocol='concat,file' --enable-demuxer='h264,hevc,mjpeg' --enable-parser='h264,hevc,mjpeg' --enable-gpl
